...
import Modify from '../screens/MainPage/Board/Modify'
    ...
    <View style={{flex: 1}}>
      ...
      <Stack.Navigator>
        ...
        <Stack.Screen
          name="QnA_Board"
          component={QnA_Board}
          options={{title: ' ', headerBackTitle: ' ', headerStatusBarHeight: 1}}
        />
        <Stack.Screen
          name="Free"
          component={Free}
        ...
        <Stack.Screen
          ...
          options={{title: '', headerStatusBarHeight: 1}}
        />
        <Stack.Screen
          name="TechItem"
          component={TechItem}
        ...
        <Stack.Screen
          name="ContWebView"
          component={ContWebView}
          options={{
            title: '',
            headerBackTitle: 'DCEC',
            headerStatusBarHeight: 1,
          }}
        />
