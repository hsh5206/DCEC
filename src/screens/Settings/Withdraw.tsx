  ...
  return(
    <SafeAreaView style={{flex:1}}>
      <View style={[styles.header,{marginTop:'25%'}]}>
        ...
        <Text style={{fontSize: 25, marginLeft: '3%', marginTop: Platform.select({ios : '10%', android: '6%'})}}>회원 탈퇴</Text>
        </View>
      ...
      <View style={[styles.content]}>
        <View style={[styles.object]}>
          ...
          <TouchableOpacity style={styles.checkButton}>
            <Text style={{color:'white', fontSize:18, fontWeight:'300'}} onPress={onPress}>확인</Text>
          </TouchableOpacity>
        </View>
        <View style={[styles.object]}>
          <TextInput placeholder="비밀번호 입력" style={[styles.inputText, {width:'100%'}]}/>
        </View>
        <View style={[styles.object]}>
        ...
        <View style= {[{alignItems:'center'}]}>
          <TouchableOpacity style={styles.signupButton}>
            <Text style={{color:'white', fontSize:18, fontWeight:'300'}} onPress={onPress}>탈퇴하기</Text>
          </TouchableOpacity>
        </View>
      </View>
