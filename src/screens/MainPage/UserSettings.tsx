...
export default function Login() {
  ...
  const logoutPress = useCallback(() => {
    Alert.alert('로그아웃 완료'), navigation.navigate('Login')
  }, [])
      ...
      <ScrollView>
        <View style={[styles.content, {alignItems: 'center'}]}>
          ...
          <View style={{marginLeft: '4%'}}>
            ...
            <Text style={{color: Colors.grey600}}>이름 : {user.name}</Text>
          </View>
        </View>
        ...
        <View style={[styles.content, {height: 200}]}>
          <View>
            ...
            <View style={{flexDirection: 'row'}}>
              <View>
                <Text style={{fontSize: 20, marginVertical: 10}}>모드</Text>
              </View>
        ...
        <View style={[styles.content, {height: 280}]}>
          <View>
            ...
            <View
              ...
              <View>
                <Text style={{fontSize: 20, marginVertical: 10}}>버전</Text>
              </View>
